<template>
    ...
    <div>
        <div style="width:750;height:440;background-color:#ffffff;position: absolute;" :style="{visibility: keyboardType == 'num' ? 'visible':'hidden'}" v-if="showKeyboard">
            ...
            <text style="position: absolute;width:150;height:220;left:600;top:220;background-color:#3399FF;color:#FFFFFF;font-size:45;text-align:center;padding-top:87.5;" @click="onKeyClick('ok')">确定</text>
            <div style="position: absolute;width:150;height:110;left:600;top:0;border-left-width:1;border-top-width:1;border-color:#dddddd;background-color:#F9F4EA;align-items:center;"@click="onKeyClick('delet')">
                <image style="width:60;height:60;margin-top:25;" :src="baseUrl + 'image/hlkb_keyboard_btn_delet.png'" resize="contain"></image>
            </div>
            <div style="position: absolute;width:150;height:110;left:450;top:330;border-left-width:1;border-top-width:1;border-color:#dddddd;align-items:center;background-color:#F9F4EA;" @click="onKeyClick('down')">
                <image style="width:60;height:60;margin-top:25;" :src="baseUrl + 'image/hlkb_keyboard_btn_keyboard.png'" resize="contain"></image>
            </div>
        </div>
        <div style="width:750;height:440;background-color:#F9F4EA;position: absolute;" :style="{visibility: keyboardType != 'num' ? 'visible':'hidden'}" v-if="showKeyboard">
            ...
            <div style="width:100;height:78;left:15;top:246;background-color:#cdcfd6;" class="keycover2">
                <image style="width:50;height:50;margin-top:14;" :src="baseUrl + 'image/hlkb_keyboard_btn_upcase.png'" resize="contain"></image>
            </div>
            <div style="width:100;height:78;left:635;top:246;background-color:#F9F4EA;" class="keycover2">
                <image style="width:50;height:50;margin-top:14;" :src="baseUrl + 'image/hlkb_keyboard_btn_delet.png'" resize="contain" @click="onKeyClick('delet')"></image>
            </div>
            ...
            <div style="width:100;height:78;left:475;top:359;background-color:#F9F4EA;" class="keycover2">
                <image style="width:50;height:50;margin-top:14;" :src="baseUrl + 'image/hlkb_keyboard_btn_keyboard.png'" resize="contain" @click="onKeyClick('down')"></image>
            </div>
    ...
    module.exports = {
        data:function(){
            return{
                ...
                normallist:[
                    {left:'0',top:'0',height:'88',v:'600'},
                    {left:'0',top:'88',height:'88',v:'601'},
                    {left:'0',top:'176',height:'88',v:'000'},
                    {left:'0',top:'264',height:'88',v:'002'},
                    {left:'0',top:'352',height:'88',v:'300'},
                    {left:'150',top:'0',height:'110',v:'1'},
                    {left:'150',top:'110',height:'110',v:'4'},
                    {left:'150',top:'220',height:'110',v:'7'},
                    {left:'150',top:'330',height:'110',v:'ABC'},
                    ...
                    {left:'600',top:'110',height:'110',v:'清空'}
                ],
                qwertlist:[],
