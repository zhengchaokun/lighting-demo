...
<script>
    import { enable, WeexBridge, Image as GImage } from  "canvas"
    export default {
        data(){
            return {}
        },
        ...
        mounted(){
            ...
            chartDrawer.drawKLine("600570.SS",8,ctx)
        }
    }
    ...
    var chart = require("../../lib/chart/index");
            ...
            return Promise.all([API.real(code),API[func](code)]).then(function (data) {
                ...
                return API.getSystemInfo().then(function (info) {
                    return chart.MinsChart({
                        ...
                        options:{
                            width:info.windowWidth-((day||that.data.stock_zs)?5:120),
                            font:'8px Arial',
                            chart:{
