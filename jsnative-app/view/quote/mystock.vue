<template>
		...
		<div>
		   	<div v-for="(v,i) in cnIndexList" class="cnIndex">
                  ...
                  <div style="height:100px;width:200px">
  	        			  <text style="flex:1;font-size: 34;font-weight: 600;margin-left: 10;" :class="[getColorWithPriceChange(item.px_change)]">{{item.last_px}}</text>
  		          		<div style="flex-direction:row;flex:1;margin-left: 10;align-items:center;margin-top:-40;">
  			          		...
  			          		<text :class="[getColorWithPriceChange(item.px_change)]" style="margin-left:2px;font-size:22;">{{getPriceChangePercent(item.px_change_rate,item.px_change)}}</text>
  		          		</div>
                  </div>
	        		</div>
	      	</div>
    ...
    border-bottom-color: #EAEAEA">
      <div style="flex-direction: row; flex:3; margin:10;margin-left: 40;padding:10;" @click="onShowSelecBoard">
        ...
        <image style="width:16;height:8;margin-left:4;margin-top:10;" :src="baseUrl+'image/tabbar_down.png'"> v</image>
      </div>
    ...
    <cell v-for='stock in stockList' class="itemcell" style="height:92" @click="goStockDetail(stock)">
      ...
      <div style="flex:60;">
        <div style="flex-direction: row;">
          ...
          <text style="width:370;font-size: 32px;color:#333333;text-overflow:ellipsis;lines:1;" :value="stock.prod_name" ></text>
        </div>
      ...
      <text  :value="stock.last_px" style="flex:30;font-size: 32;margin:4; margin-right:40;padding:10; text-align:right;font-weight: 600;" :style="{color:stock.color}"></text>
      <text style="flex:23;font-size:32;margin:12; margin-right: 10;padding:10; text-align:center; border-radius: 8; color:#ffffff" :style="{backgroundColor:stock.color}">{{getPriceChangePercent(stock.px_change_rate,0)}}</text>
    </cell> 
  </list>
