<template>
    ...
    <div @viewappear="onViewappear">
        <div style="width:750;height:110;background-color:#ffffff;flex-direction: row;align-items:center;">
        ...
        <list style="flex: 12;" v-if='hasResult'>
            <cell v-for='item in resultlist'>
                ...
                <div style="flex-direction: row;align-items:center;width:750;height:100;" @click="onItemClick(item)">
                    <marketicon :icon="item.marketicon" marginType="search" style="height:25;margin-right:4;margin-top:2;"></marketicon>
                    <text style="line:1;font-size:35;color:#999999;text-align:left;" :value="item.displayCode"></text>
                    <text style="line:1;font-size:35;color:#999999;text-overflow:ellipsis;text-align:left;margin-left:30;" :value="item.stockName"></text>
                    <biz style="margin-right:30;" :iconItems="item.busiFlag"></biz>
