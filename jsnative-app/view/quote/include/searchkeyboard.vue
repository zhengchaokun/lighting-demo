<template>
    ...
    <div>
        <div style="width:750;height:440;background-color:#ffffff;position: absolute;" :style="{visibility: keyboardType == 'num' ? 'visible':'hidden'}" v-if="showKeyboard">
            ...
            <div style="position: absolute;width:150;height:110;left:600;top:0;border-left-width:1;border-top-width:1;border-color:#dddddd;align-items:center;"@click="onKeyClick('delet')">
                <image style="width:60;height:60;margin-top:25;" :src="baseUrl + 'image/hlkb_keyboard_btn_delet.png'" resize="contain"></image>
            </div>
            <div style="position: absolute;width:150;height:110;left:450;top:330;border-left-width:1;border-top-width:1;border-color:#dddddd;align-items:center;" @click="onKeyClick('down')">
