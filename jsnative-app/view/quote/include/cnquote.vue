<template>
	<list>
		...
		<!--跌幅榜 -->
		<collapseview ref="coll3" title="跌幅榜" :showContent="show3" rightTitle=" ••• " rightFontColor="#ccc" @rightonclick="onRightClick(ranklistparams[2])">
		...
		<!--换手率榜 -->
		<collapseview ref="coll4" title="换手率榜" :showContent="show4" rightTitle=" ••• " rightFontColor="#ccc" @rightonclick="onRightClick(ranklistparams[3])">
