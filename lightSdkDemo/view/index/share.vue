...
<template>
    <div class="apiContent">
        ...
        <div class="normalList"><text class="mr10 fs14 width70">标题：</text><input v-model="title" class="inputStyle" type="text" placeholder=""/></div>
        <div class="normalList"><text class="mr10 fs14 width70">内容：</text><input v-model="content" class="inputStyle" type="text" placeholder=""/></div>
        <div class="normalList"><text class="mr10 fs14 width70">图片地址：</text><input v-model="imgsrc" class="inputStyle" type="text" placeholder=""/></div>
        <div class="normalList"><text class="mr10 fs14 width70">链接地址：</text><input v-model="url" class="inputStyle" type="text" placeholder=""/></div>
        <div class="normalList"><text class="buttonStyle" @click="share()">分享</text></div>
