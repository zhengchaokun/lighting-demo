  ...
  <div class="lc-demo">
    <scroller class="scroller">
      ...
      <category title="四种事件"></category>
        ...
        <lc-textarea placeholder="提示" @on-focus="onEvent('focus')"></lc-textarea>

        <text class="title-text">blur事件</text>       
        <lc-textarea placeholder="提示" @on-blur="onEvent('blur')"></lc-textarea>

        <text class="title-text">input事件</text>
        <lc-textarea placeholder="提示" @on-input="onEvent('input')"></lc-textarea>

        <text class="title-text">change事件</text>
        <lc-textarea placeholder="提示" @on-change="onEvent('change')"></lc-textarea>
