...
<template>
  ...
  <div class="lc-demo">
    <scroller class="scroller">
      ...
      <lc-input label="单项输入" placeholder="预设内容" @on-focus="onEvent('focus')"></lc-input>

      <text class="hint">blur事件</text> 
      <lc-input label="单项输入" placeholder="预设内容" @on-blur="onEvent('blur')"></lc-input>

      <text class="hint">enter事件</text> 
      <lc-input label="单项输入" placeholder="输入完成后回车" v-model="enterText" @on-enter="onEvent('enter')"></lc-input>

      <text class="hint">input事件</text> 
      <lc-input label="单项输入" @on-input="onEvent('input')" placeholder="预设内容"></lc-input>
